...
from tests.conftest import AGENT_VAULT_PLACEHOLDER_TOKEN, _AGENT_VAULT_AUTH_VERSION, _AGENT_VAULT_CONTAINER_CA_PATH, _AGENT_VAULT_TRUST_VARS, _ANTHROPIC_OAUTH_SHIM_NAME, _BAKED_DEP_CANONICAL_REPOS, _BC_BASE_BEADS_BINARY_OWNER, _BC_BASE_BEADS_BINARY_VERSION, _BC_BASE_DOCKERFILE_REL, _BC_BASE_FRAMEWORK_CLI_PINS, _BOOTSTRAP_FRAMEWORK_CLIS, _FABRO_CANONICAL_REPO, _HEALTHCHECK_BROKER_ENV, _HEALTHCHECK_DB_ENV, _REAL_OAUTH_TOKEN, _REPO_ROOT, _SELF_PIN_CANONICAL_REPO, _SELF_PIN_DEP_KEY, _UPSTREAM_BASE_VERSION_LABEL, _baked_claude_json, _baked_credentials_json, _baked_shop_templates_version, _bc_base_dockerfile_text, _bootstrap_entrypoint_path, _bss3_poll_exec_body, _build_step_for_image, _ca_trust_script_path, _centralized_poll_workflow, _committed_oauth_shim_path, _dockerfile_arg_declared, _dockerfile_env_value, _dockerfile_healthcheck_directive, _effective_final_user, _find_bc_base_dockerfile, _find_step, _healthcheck_script_path, _load_workflows, _parse_kv_block, _publish_workflow_doc, _shop_templates_pinned_by_version_shape, _strip_dockerfile_comments, _strip_sh_comments, _strip_yaml_comments, _top_level_imported_modules, _workflow_on, _workflow_text, given, parsers, re, subprocess, sys, then, when  # noqa: F401
